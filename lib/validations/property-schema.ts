...
export type { PropertyType, PropertyTag } from "@/lib/generated/prisma";

// ── Enums derived from Prisma ─────────────────────────────────
export const PROPERTY_TYPES = Object.values(PropertyTypeEnum) as unknown as readonly [
  import("@/lib/generated/prisma").PropertyType,
  ...import("@/lib/generated/prisma").PropertyType[],
];

export const PROPERTY_TAGS = Object.values(PropertyTagEnum) as unknown as readonly [
  import("@/lib/generated/prisma").PropertyTag,
  ...import("@/lib/generated/prisma").PropertyTag[],
];

// ── Display helpers ───────────────────────────────────────────
export const PROPERTY_TYPE_LABELS: Record<import("@/lib/generated/prisma").PropertyType, string> = {
  APARTMENT: "Apartment",
  HOUSE: "House",
...
export const PROPERTY_TAG_LABELS: Record<import("@/lib/generated/prisma").PropertyTag, string> = {
  RENTED: "Rented",
  VACANT: "Vacant",
  FOR_SALE: "For Sale",
...
export const propertyFormSchema = z.object({
  ...
  purchasePrice: z.union([z.coerce.number().positive("Must be a positive number"), z.literal("")]),
